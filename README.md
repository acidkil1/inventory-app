...
##💡 Быстрый старт и тестовые данные:
При первом запуске приложение автоматически создаст пустую базу данных inventory.db. Чтобы сразу увидеть, как работает система с данными, используйте файл inventory_import.xlsx в корне репозитория. Перейдите в раздел "Экспорт/Импорт" в приложении и загрузите этот файл – база данных автоматически заполнится тестовыми записями.
